...
contextBridge.exposeInMainWorld('api', {
  ...
  gitSlotenOpruimen: (dirs) => ipcRenderer.invoke('git:slotenOpruimen', dirs),
  ...
  gitBeschermMain: (d) => ipcRenderer.invoke('git:beschermMain', d),
  gitViaGhInloggen: () => ipcRenderer.invoke('git:viaGhInloggen'),
  logLees: (o) => ipcRenderer.invoke('log:lees', o),
  logZet: (o) => ipcRenderer.invoke('log:zet', o),
  logWis: () => ipcRenderer.invoke('log:wis'),
  logMap: () => ipcRenderer.invoke('log:map'),
  ...
  gitAfsluitLuistert: ()  => ipcRenderer.send('git:afsluitLuistert'),
  ...
  conflictScan:  (o)     => ipcRenderer.invoke('cmd:conflictScan', o),
  conflictKill:  (o)     => ipcRenderer.invoke('cmd:conflictKill', o),
  openTaskManager: ()    => ipcRenderer.invoke('cmd:openTaskManager'),
